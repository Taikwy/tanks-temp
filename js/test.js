...
// game variables
let startScene;
let gameScene,ship,waveLabel,lifeLabel,shootSound,hitSound,fireballSound;
let gameOverScene;
...
function createLabelsAndButtons(){
    ...
    gameOverScoreLabel.y = sceneHeight/2 +30;
...
function gameLoop(){
	...
	for(let c of circles){
        ...
        if(c.y <= c.radius || c.xy >= sceneHeight-c.radius){
            c.reflectY();
            c.move(dt);
        }
    }
